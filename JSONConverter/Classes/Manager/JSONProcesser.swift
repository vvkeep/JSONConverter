...
class JSONProcesser {
    ...
    private let builders: [BuilderProtocol] = [ObjCBuilder(), SwiftBuilder(), SwiftyJSONBuilder(), ObjectMapperBuilder(), FlutterBuilder(), HandyJSONBuilder(), CodableBuilder(), JavaBuilder()]
